...
#include <atomic>
//===================================================芯片 SDK 底层===================================================
#define DIR1   "/dev/zf_driver_gpio_motor_1"
#define PWM2   "/dev/zf_device_pwm_motor_1"

#define DIR2  "/dev/zf_driver_gpio_motor_2"
#define PWM1   "/dev/zf_device_pwm_motor_2"
